...
USE_DOT_ENV = env.bool("DJANGO_USE_DOT_ENV", False)
if USE_DOT_ENV:
...
ALLOWED_HOSTS = env.list("DJANGO_HOST_ADDRESS", default=[])
CORS_ALLOWED_ORIGINS = env.list("FRONT_END_BASE_URL", default=[])
...
DATABASES = {
    ...
    #     "PORT": env.str("DATABASE_PORT", None),
    # }
    "default": {
